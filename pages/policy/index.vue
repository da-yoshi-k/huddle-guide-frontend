...
<template>
  <div class="md:w-auto flex justify-center">
    <div class="flex flex-col justify-center mx-8 my-8 md:w-3/5">
      ...
      <div class="mb-4">
        ...
        <p class="mx-2">当方は、お客様から以下の情報を取得します。</p>
        <ul class="list-disc ml-6 mt-2">
          ...
          <li>当方ウェブサイトの滞在時間、入力履歴、購買履歴等の当方ウェブサイトにおけるお客様の行動履歴</li>
          <li>当方アプリの起動時間、入力履歴、購買履歴等の当方アプリの利用履歴</li>
        </ul>
      </div>
      <div class="mb-4">
        <h3 class="text-lg font-bold">お客様の情報を利用する目的</h3>
        <p class="mx-2">当方は、お客様から取得した情報を、以下の目的のために利用します。</p>
        <ul class="list-disc ml-6 mt-2">
      ...
      <div class="mb-4">
        ...
        <p class="mx-2">当方が、お客様から取得した情報に関して安全管理のために講じた措置につきましては、末尾記載のお問い合わせ先にご連絡をいただきましたら、法令の定めに従い個別にご回答させていただきます。</p>
      </div>
      <div class="mb-4">
      ...
      <div class="mb-4">
        ...
        <p class="mx-2">
          当方は、お客様のアクセス解析のために、「Googleアナリティクス」を利用しています。Googleアナリティクスは、トラフィックデータの収集のためにCookieを使用しています。トラフィックデータは匿名で収集されており、個人を特定するものではありません。Cookieを無効にすれば、これらの情報の収集を拒否することができます。詳しくはお使いのブラウザの設定をご確認ください。Googleアナリティクスについて、詳しくは<a
      ...
      <div class="mb-4">
        ...
        <h4 class="ml-2 font-bold">e-mail(以下のアットマークを半角に変換してください)</h4>
        <p class="mx-8 mb-2">
          huddleguide.app＠gmail.com
        </p>
        <p class="mx-2">
