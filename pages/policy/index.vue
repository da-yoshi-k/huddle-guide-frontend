  ...
  <div class="md:w-auto flex justify-center">
    <div class="flex flex-col justify-center mx-8 my-8 md:w-3/5">
      ...
      <div class="mb-4">
        ...
        <p class="mx-2">当社は、お客様から以下の情報を取得します。</p>
      ...
      <div class="mb-4">
        ...
        <p class="mx-2">当社は、お客様から取得した情報を、以下の目的のために利用します。</p>
        <ul class="list-disc ml-6 mt-2">
      ...
      <div class="mb-4">
        ...
        <p class="mx-2">当社が、お客様から取得した情報に関して安全管理のために講じた措置につきましては、末尾記載のお問い合わせ先にご連絡をいただきましたら、法令の定めに従い個別にご回答させていただきます。</p>
      </div>
      <div class="mb-4">
        <h3 class="text-lg font-bold">第三者提供</h3>
        <p class="mx-2">
          当社は、お客様から取得する情報のうち、個人データ（個人情報保護法第２条第６項）に該当するものついては、あらかじめお客様の同意を得ずに、第三者（日本国外にある者を含みます。）に提供しません。<br />
          但し、次の場合は除きます。
        </p>
        <ul class="list-disc ml-6 mt-2">
