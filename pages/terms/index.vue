...
<template>
  <div class="w-auto flex justify-center">
    <div class="flex flex-col justify-center mx-8 my-8 md:w-3/5">
      <div class="mb-4">
        <h2 class="text-center text-3xl font-bold mb-4 text-black">利用規約</h2>
        <p>
          この利用規約（以下，「本規約」といいます。）は，Kazuki Yoshida（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。<br />
          登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
      </div>
      <div class="mb-4">
        <h3 class="text-lg font-bold">第1条（適用）</h3>
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第2条（利用登録）</h3>
        <ul class="list-decimal ml-6">
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第3条（ユーザーIDおよびパスワードの管理）</h3>
        <ul class="list-decimal ml-6">
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第4条（利用料金および支払方法）</h3>
        <ul class="list-decimal ml-6">
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第5条（禁止事項）</h3>
        ...
        <ul class="list-decimal ml-6">
          ...
          <li>以下の表現を含み，または含むと当方が判断する内容を本サービス上に投稿し，または送信する行為</li>
          <ul class="list-decimal ml-6">
            <li>過度に暴力的な表現</li>
            <li>露骨な性的表現</li>
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第6条（本サービスの提供の停止等）</h3>
        <ul class="list-decimal ml-6">
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第7条（著作権）</h3>
        <ul class="list-decimal ml-6">
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第8条（利用制限および登録抹消）</h3>
        <ul class="list-decimal ml-6">
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第9条（退会）</h3>
        <ul class="list-decimal ml-6">
          <li>ユーザーは，当方の定める退会手続により，本サービスから退会できるものとします。</li>
        </ul>
      </div>
      <div class="mb-4">
        <h3 class="text-lg font-bold">第10条（保証の否認および免責事項）</h3>
        <ul class="list-decimal ml-6">
          <li>
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第11条（サービス内容の変更等）</h3>
        <p>当方は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
      </div>
      <div class="mb-4">
        <h3 class="text-lg font-bold">第12条（利用規約の変更）</h3>
        <ul class="list-decimal ml-6">
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第13条（個人情報の取扱い）</h3>
        <p>当方は，本サービスの利用によって取得する個人情報については，当方「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
      </div>
      <div class="mb-4">
        <h3 class="text-lg font-bold">第14条（通知または連絡）</h3>
        <p>
      ...
      <div class="mb-4">
        <h3 class="text-lg font-bold">第15条（権利義務の譲渡の禁止）</h3>
        <p>ユーザーは，当方の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
      </div>
      <div class="mb-4">
        <h3 class="text-lg font-bold">第16条（準拠法・裁判管轄）</h3>
        <ul class="list-decimal ml-6">
